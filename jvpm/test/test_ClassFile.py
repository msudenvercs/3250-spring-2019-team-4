...
class testClass(unittest.TestCase):
    ...
    def test_get_magic_number(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_magic_number(self.unittest_file),
            "CAFEBABE",
        )

    def test_get_major(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_minor(self.unittest_file), "0000"
        )

    def test_get_minor(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_major(self.unittest_file), "0037"
        )

    def test_get_pool_count_raw(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_pool_count_raw(self.unittest_file),
            "0026",
        )

    def test_get_pool_count(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_pool_count(self.unittest_file), "0025"
        )

    def test_get_pool_count_raw_int(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_pool_count_raw_int(self.unittest_file),
            int("0026", 16),
        )

    def test_get_pool_count_int(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_pool_count_int(self.unittest_file),
            int("0025", 16),
        )
    ...
    def test_get_constant_table(self):
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_constant_table(self.unittest_file),
            expected_table,
        )

    def test_get_constant_table_size(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_constant_table_size(
                self.unittest_file
            ),
            369,
        )
    ...
    def test_get_access_flag(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_access_flag(self.unittest_file), "0021"
        )

    def test_get_class_identifier(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_class_identifier(self.unittest_file),
            "07001F",
        )

    def test_get_superclass_identifier(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_superclass_identifier(
                self.unittest_file
            ),
            "01000C6669656C645F737472696E67",
        )
    ...
    def test_get_interface_count(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_interface_count(self.unittest_file),
            "0001",
        )
    ...
    def test_get_interface_table(self):
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_interface_table(self.unittest_file),
            expected_table,
        )

    def test_get_interface_table_size(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_interface_table_size(
                self.unittest_file
            ),
            2,
        )
    ...
    def test_get_interfaces(self):
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_interfaces(self.unittest_file),
            expected_table,
        )

    def test_get_field_count(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_field_count(self.unittest_file), "0001"
        )

    def test_get_field_table(self):
        expected_table = ["0000000A000B0000"]
        self.assertEqual(
            ClassFile.JavaClassFile.get_field_table(self.unittest_file),
            expected_table,
        )

    def test_get_field_table_size(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_field_table_size(self.unittest_file), 8
        )

    def test_get_fields(self):
        expected_table = {
            "Field 1": "0100124C6A6176612F6C616E672F537472696E673B",
            "Field 1 Descriptor": "0100063C696E69743E",
            "Field 1 Attributes": {},
        }
        self.assertEqual(
            ClassFile.JavaClassFile.get_fields(self.unittest_file),
            expected_table,
        )

    def test_get_method_count(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_method_count(self.unittest_file),
            "0003",
        )

    def test_get_method_table(self):
        expected_table = [
            "0001000C000D0001000E00000027000200010000000B2AB700012A1202B50003B100000001000F0000000A00020000000100040002",
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_method_table(self.unittest_file),
            expected_table,
        )

    def test_get_method_table_size(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_method_table_size(self.unittest_file),
            156,
        )

    def test_get_methods(self):
        expected_table = {
            "Method 1": "010003282956",
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_methods(self.unittest_file),
            expected_table,
        )

    def test_get_attribute_count(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_attribute_count(self.unittest_file),
            "0001",
        )
    ...
    def test_get_attribute_table(self):
        ...
        self.assertEqual(
            ClassFile.JavaClassFile.get_attribute_table(self.unittest_file),
            expected_table,
        )

    def test_get_attribute_table_size(self):
        self.assertEqual(
            ClassFile.JavaClassFile.get_attribute_table_size(
                self.unittest_file
            ),
            8,
        )
