...
class test_op_codes(unittest.TestCase):
    ...
    def test_opcode3b(self):
        test_stack = []
        test_localvar = [20,30]
        test_stack = op_codes1.op_codes.op_code3b(test_localvar, test_stack)
        self.assertEqual (test_stack.pop(),20)

    def test_opcode3c(self):
        test_stack = []
        test_localvar = [20,30,40]
        test_stack = op_codes1.op_codes.op_code3c(test_localvar, test_stack)
        self.assertEqual(test_stack.pop(), 30)

    def test_opcode3d(self):
        test_stack = []
        test_localvar = [20,30,40,50]
        test_stack = op_codes1.op_codes.op_code3d(test_localvar, test_stack)
